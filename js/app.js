(() => {
    ...
    function initSliders() {
        if (document.querySelector(".burgers__slider")) new swiper_core_Swiper(".burgers__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".burgers-two__slider")) new swiper_core_Swiper(".burgers-two__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.65,
